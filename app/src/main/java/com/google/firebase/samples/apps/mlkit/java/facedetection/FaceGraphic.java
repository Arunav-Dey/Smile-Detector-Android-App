...
public class FaceGraphic extends Graphic {
    ...
    public void draw(Canvas canvas) {
       ...
       // canvas.drawLine(x - ID_X_OFFSET,y, x + ID_X_OFFSET * 6,y,idPaint);
       // canvas.drawText("id: " + face.getTrackingId(), x + ID_X_OFFSET, y - 3 * ID_Y_OFFSET, idPaint);
        /*canvas.drawText(
                "happiness: " + face.getSmilingProbability(),
                x + ID_X_OFFSET * 3,
                y - 2 * ID_Y_OFFSET,
                idPaint);*/
        if (facing == CameraSource.CAMERA_FACING_FRONT) {
            ...
            /*canvas.drawText(
                    ...
                    y,
                    idPaint);*/
            if(Float.parseFloat(String.valueOf(face.getSmilingProbability()))>=0.50){
            canvas.drawText(
                    "Vanshika you have a gorgeous Smile" ,
                    40,
                    40,
                    idPaint);}
            /*else if(facing == CameraSource.CAMERA_FACING_BACK)
            {
                Toast. makeText(getApplicationContext(),"Please switch to Front Camera",Toast. LENGTH_LONG);
            }*/
        } else {
            canvas.drawText(
                    "left eye: " + String.format("%.2f", face.getLeftEyeOpenProbability()),
      ...
      //  drawBitmapOverLandmarkPosition(canvas, face, FirebaseVisionFaceLandmark.LEFT_EAR);
        //drawBitmapOverLandmarkPosition(canvas, face, FirebaseVisionFaceLandmark.RIGHT_EAR);
        //drawBitmapOverLandmarkPosition(canvas, face, FirebaseVisionFaceLandmark.LEFT_EYE);
        //drawBitmapOverLandmarkPosition(canvas, face, FirebaseVisionFaceLandmark.RIGHT_EYE);
    }
